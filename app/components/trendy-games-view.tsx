  ...
  return (
    <div className="container mx-auto p-4 md:p-6 space-y-6 bg-gradient-to-b from-gray-50 to-white min-h-screen">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h1 className="text-3xl md:text-4xl font-bold text-primary-black-900 tracking-tight">Trendy Games</h1>
          <p className="text-primary-black-600 mt-1">Compare odds across major sportsbooks for upcoming games only</p>
          <p className="text-xs text-primary-black-500 mt-1">Note: Games that have already started are not shown</p>
        </div>
...
function OddsCard({ value, odds, sportsbook }: { value: string, odds: string, sportsbook?: string }) {
  return (
    <div className="bg-white rounded-lg p-4 flex flex-col 
      border border-primary-black-100 hover:border-primary-black-200 hover:bg-primary-black-50
      ...
      <div className="flex items-center gap-2 mb-1.5">
        ...
        <span className="text-[11px] font-medium text-primary-black-500 uppercase tracking-wider group-hover:text-primary-black-700">
          {sportsbook || '-'}
        </span>
      </div>
      <div>
        <div className="text-xl font-bold text-primary-black-800 tracking-tight group-hover:text-primary-black-900">{value}</div>
        <div className="text-sm text-primary-black-500 font-medium mt-0.5">{odds}</div>
      </div>
    </div>
  )
}
